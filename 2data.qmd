...
*	Your own MIC and MBC data for Antibiotic X (or the class data available on MyPlace) - you will use these data in @sec-task2B.

*	MIC/MBC data for antibiotic X against mutant *E. coli* strains - you will use these data in @sec-task2C.

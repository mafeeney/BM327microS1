...
Isolation of a new antibiotic from Streptomyces coelicolor:
Mapping mutations that confer antibiotic resistance

You have isolated a species of Streptomyces that produces a novel antibiotic that can kill Escherichia coli and other Gram-negative bacteria. In the previous lab, you isolated E. coli strains that are resistant to this particular antibiotic.

In order to identify the mutation(s) that give rise to the antibiotic resistance phenotype, you will physically map the location of the mutations using interrupted mating. You will first analyse the data from the interrupted mating experiment (Task 3A), and then form a hypothesis about the location of the antibiotic-resistance mutation (Task 3B). 
...
You will perform Protocol 3.1 in the Week 6 lab and collect your data the following session (Week 8). Perform the data analysis tasks (Task 3A and Task 3B) using your own data/the class data or the sample data available on MyPlace.

...
You will perform Protocols 2.1 and 2.4 in the Week 4 lab and collect your data in the following sessions (Weeks 6 & 8). Perform the data analysis tasks (@sec-data2) using your own data or the sample data available on MyPlace.

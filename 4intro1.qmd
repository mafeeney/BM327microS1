...
A fundamental difficulty in biology lies in our ability to link genotype and phenotype: for example, as in this experiment as we try to link the known phenotype (antibiotic resistance) with the unknown mutation causing the phenotype (location of the Tn*5* insertion).
